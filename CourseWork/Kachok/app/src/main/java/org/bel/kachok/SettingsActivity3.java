...
public class SettingsActivity3 extends AppCompatPreferenceActivity {
    ...
    private static final String TAG = "SettingsActivity3";
    ...
    public void onBuildHeaders(List<Header> target) {
        ...
        loadHeadersFromResource(R.xml.pref_headers3, target);
    }
    ...
    public static class GeneralPreferenceFragment extends PreferenceFragment implements
        ...
        public void onCreate(Bundle savedInstanceState) {
            super.onCreate(savedInstanceState);
            addPreferencesFromResource(R.xml.pref_general3);
        ...
        Preference.OnPreferenceChangeListener notificationListener =
                new Preference.OnPreferenceChangeListener() {
                    ...
                    public boolean onPreferenceChange(Preference preference, Object o) {
                        ...
                        NotificationService3.setNotificationServiceAlarm(getActivity(),
                                                                        isEnabled);
                        return true;
                    }
                };
    ...
    public static class WidgetPreferenceFragment extends PreferenceFragment implements
        ...
        public void onCreate(Bundle savedInstanceState) {
            super.onCreate(savedInstanceState);
            addPreferencesFromResource(R.xml.pref_widget3);
        }

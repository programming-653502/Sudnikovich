...
import org.bel.kachok.model.CitySearch;
...
import org.bel.kachok.utils.PermissionUtil;
import org.bel.kachok.utils.Utils;

import java.util.Locale;

import static org.bel.kachok.utils.AppPreference3.saveLastUpdateTimeMillis;

public class MainActivity33 extends BaseActivity3 implements AppBarLayout.OnOffsetChangedListener {

    private static final String TAG = "MainActivity33";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        connectionDetector = new ConnectionDetector(MainActivity33.this);
        locationManager = (LocationManager) getSystemService(Context.LOCATION_SERVICE);
        AppPreference3.setLocale(this, Constants.APP_SETTINGS_NAME);
    ...
    private void updateCurrentWeather() {
        AppPreference3.saveWeather(MainActivity33.this, mWeather);
        mSharedPreferences = getSharedPreferences(Constants.APP_SETTINGS_NAME,
                Context.MODE_PRIVATE);
        SharedPreferences.Editor configEditor = mSharedPreferences.edit();

        mSpeedScale = Utils.getSpeedScale(MainActivity33.this);
        ...
        String lastUpdate = Utils.setLastUpdateTime(MainActivity33.this,
                saveLastUpdateTimeMillis(MainActivity33.this));
        String sunrise = Utils.unixTimeToFormatTime(MainActivity33.this, mWeather.sys.getSunrise());
        String sunset = Utils.unixTimeToFormatTime(MainActivity33.this, mWeather.sys.getSunset());

        mIconWeatherView.setText(
                Utils.getStrIcon(MainActivity33.this, mWeather.currentWeather.getIdIcon()));
        mTemperatureView.setText(getString(R.string.temperature_with_degree, temperature));
        if (!AppPreference3.hideDescription(MainActivity33.this))
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        menuInflater.inflate(R.menu.activity_main_menu3, menu);
        ...
        switch (item.getItemId()) {
            case R.id.main_menu_refresh:
                if (connectionDetector.isNetworkAvailableAndConnected()) {
                    ...
                    Toast.makeText(MainActivity33.this,
            ...
            case R.id.main_menu_search_city:
                Intent intent = new Intent(MainActivity33.this, SearchActivity3.class);
    ...
    private LocationListener mLocationListener = new LocationListener() {
        ...
        public void onLocationChanged(Location location) {
            ...
            if (ContextCompat.checkSelfPermission(MainActivity33.this, Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED) {
            ...
            if (isNetworkAvailable) {
                startService(new Intent(MainActivity33.this, CurrentWeatherService.class));
                sendBroadcast(new Intent(Constants.ACTION_FORCED_APPWIDGET_UPDATE));
            } else {
                Toast.makeText(MainActivity33.this, R.string.connection_not_found, Toast.LENGTH_SHORT)
                     .show();
            }
        }
    ...
    private void preLoadWeather() {
        mUnits = AppPreference3.getTemperatureUnit(this);
        mSpeedScale = Utils.getSpeedScale(this);
        String lastUpdate = Utils.setLastUpdateTime(this,
                AppPreference3.getLastUpdateTimeMillis(this));
    ...
    FloatingActionButton.OnClickListener fabListener = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            String temperatureScale = Utils.getTemperatureScale(MainActivity33.this);
            mSpeedScale = Utils.getSpeedScale(MainActivity33.this);
            String weather;
            String city;
            String temperature;
            ...
            sunrise = Utils.unixTimeToFormatTime(MainActivity33.this, mPrefWeather
                    .getLong(Constants.WEATHER_DATA_SUNRISE, -1));
            sunset = Utils.unixTimeToFormatTime(MainActivity33.this, mPrefWeather
    ...
    private void detectLocation() {
        ...
        mProgressDialog = new ProgressDialog(MainActivity33.this);
    ...
    public void showSettingsAlert() {
        AlertDialog.Builder settingsAlert = new AlertDialog.Builder(MainActivity33.this);
    ...
    private void requestLocation() {
        int fineLocationPermission = ContextCompat.checkSelfPermission(MainActivity33.this, Manifest.permission.ACCESS_FINE_LOCATION);
        ...
        if (ActivityCompat.shouldShowRequestPermissionRationale(this,Manifest.permission.ACCESS_FINE_LOCATION)) {
            Snackbar.make(findViewById(android.R.id.content), R.string.permission_location_rationale, Snackbar.LENGTH_LONG)
                    .setAction(android.R.string.ok, new View.OnClickListener() {
                        @Override
                        public void onClick(View view) {
                            ActivityCompat.requestPermissions(MainActivity33.this, PERMISSIONS_LOCATION, REQUEST_LOCATION);
                        }
                    }).show();
        } else {

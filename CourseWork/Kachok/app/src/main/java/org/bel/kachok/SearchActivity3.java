...
import org.bel.kachok.utils.CityParser;
...
public class SearchActivity3 extends AppCompatActivity {
    ...
    public static final String TAG = "SearchActivity3";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(SearchActivity3.this));
    ...
    private class SearchCityAdapter extends RecyclerView.Adapter<SearchCityHolder> implements
        ...
        public SearchCityHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            LayoutInflater inflater = LayoutInflater.from(SearchActivity3.this);

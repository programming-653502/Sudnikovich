...
public class LessWidgetService extends IntentService {
    ...
    private void updateWidget(Weather weather) {
        ...
        for (int appWidgetId : widgetIds) {
            ...
            String[] cityAndCountryArray = AppPreference3.getCityAndCode(this);
            String cityAndCountry = cityAndCountryArray[0] + ", " + cityAndCountryArray[1];
            String lastUpdate = Utils.setLastUpdateTime(this, AppPreference3
            ...
            if(!AppPreference3.hideDescription(this))

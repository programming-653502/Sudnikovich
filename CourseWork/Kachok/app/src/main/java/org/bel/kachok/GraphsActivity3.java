...
import org.bel.kachok.utils.CustomValueFormatter;
import org.bel.kachok.utils.Utils;
import org.bel.kachok.utils.XAxisValueFormatter;
import org.bel.kachok.utils.YAxisValueFormatter;
...
public class GraphsActivity3 extends BaseActivity3 {
            ...
            public void handleMessage(android.os.Message msg) {
                switch (msg.what) {
                    case Constants.TASK_RESULT_ERROR:
                        Toast.makeText(GraphsActivity3.this,
                    ...
                    case Constants.PARSE_RESULT_SUCCESS:
                        ...
                        if (!mForecastList.isEmpty()) {
                            AppPreference3.saveWeatherForecast(GraphsActivity3.this,
                                                              mForecastList);
                        }
                        break;
                }
    ...
    protected void onResume() {
        super.onResume();
        mForecastList = AppPreference3.loadWeatherForecast(this);
        updateUI();
    }
    ...
    private void getWeather() {
        Thread t = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                String locale = AppPreference3.getLocale(GraphsActivity3.this,
                                                        Constants.APP_SETTINGS_NAME);
                String units = AppPreference3.getTemperatureUnit(GraphsActivity3.this);
                ...
                try {
                    ...
                    if (connection.getResponseCode() == HttpURLConnection.HTTP_OK) {
                        ...
                        AppPreference3.saveLastUpdateTimeMillis(GraphsActivity3.this);
                    }
                } catch (IOException e) {

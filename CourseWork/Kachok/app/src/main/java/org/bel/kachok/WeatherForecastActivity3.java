...
import org.bel.kachok.adapters.WeatherForecastAdapter;
import org.bel.kachok.model.WeatherForecast;
...
import static org.bel.kachok.utils.Utils.getWeatherForecastUrl;

public class WeatherForecastActivity3 extends BaseActivity3 {

    private final String TAG = "WeatherForecastActivity3";
            ...
            public void handleMessage(android.os.Message msg) {
                switch (msg.what) {
                    case Constants.TASK_RESULT_ERROR:
                        Toast.makeText(WeatherForecastActivity3.this,
                    ...
                    case Constants.PARSE_RESULT_SUCCESS:
                        ...
                        if (!mWeatherForecastList.isEmpty()) {
                            AppPreference3.saveWeatherForecast(WeatherForecastActivity3.this,
    ...
    public void onResume() {
        super.onResume();
        if (mWeatherForecastList.isEmpty()) {
            mWeatherForecastList = AppPreference3.loadWeatherForecast(this);
        }
        updateUI();
    }
    ...
    private void getWeather() {
        Thread t = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                String locale = AppPreference3.getLocale(WeatherForecastActivity3.this,
                                                        Constants.APP_SETTINGS_NAME);
                String units = AppPreference3.getTemperatureUnit(WeatherForecastActivity3.this);
                ...
                try {
                    ...
                    if (connection.getResponseCode() == HttpURLConnection.HTTP_OK) {
                        ...
                        AppPreference3.saveLastUpdateTimeMillis(WeatherForecastActivity3.this);
                    }
                } catch (IOException e) {

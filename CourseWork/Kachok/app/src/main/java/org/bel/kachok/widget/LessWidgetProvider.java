...
import org.bel.kachok.utils.AppWidgetProviderAlarm;
...
public class LessWidgetProvider extends AppWidgetProvider {
    ...
    public void onReceive(Context context, Intent intent) {
        switch (intent.getAction()) {
            ...
            case Intent.ACTION_LOCALE_CHANGED:
                AppPreference3.setLocale(context, Constants.APP_SETTINGS_NAME);
                context.startService(new Intent(context, LessWidgetService.class));
                break;
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        ...
        for (int appWidgetId : appWidgetIds) {
            ...
            Intent intentStartActivity = new Intent(context, MainActivity33.class);
    ...
    private void preLoadWeather(Context context, RemoteViews remoteViews) {
        ...
        String[] cityAndCountryArray = AppPreference3.getCityAndCode(context);
        ...
        String lastUpdate = Utils.setLastUpdateTime(context,
                                                    AppPreference3.getLastUpdateTimeMillis(context));
        ...
        if(!AppPreference3.hideDescription(context))
    ...
    private void setWidgetTheme(Context context, RemoteViews remoteViews) {
        ...
        if (!AppPreference3.isLightThemeEnabled(context)) {
